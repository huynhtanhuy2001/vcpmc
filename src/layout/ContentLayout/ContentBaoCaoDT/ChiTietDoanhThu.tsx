    ...
    <div className="Content-App">
      ...
      <div className="Content-body">
        <div className="ChiTietDoanhThu">
          <div className="ChiTietDoanhThu_Left">
            <div className="ChiTietDoanhThu_Left-Top">
              <div className="ChiTietDoanhThu_Left-Title">
                <h3>Thông tin hợp đồng</h3>
              </div>
              <div className="ChiTietDoanhThu_Left-Form">
                <Form>
            ...
            <div className="ChiTietDoanhThu_Left-Bottom">
              <div className="ChiTietDoanhThu_Left-Title">
          ...
          <div className="ChiTietDoanhThu_Right">
            <div className="ChiTietDoanhThu_Right_Title">
              <h3>Danh sách bản ghi</h3>
            </div>
            <div className="ChiTietDoanhThu_Right_Control">
